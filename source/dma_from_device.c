...
int main(int argc, char *argv[])
{
	...
	float avBW = 0;
	// Send and measure the performance of four 1MB data chunks instead of one 4GB data packet.
	// The amount of data can be changed according to requirements.
	for(int j = 0; j < 4; j++){
